...
sao lưu bằng `scripts/backup-data.sh` lên Google Drive (remote rclone `gdrive`).
...
- **Google Drive:** `Backups/ctslab-web/`
...
rclone ls gdrive:Backups/ctslab-web/daily/            # xem các bản
rclone copy gdrive:Backups/ctslab-web/daily/ctslab-web_<ngày_giờ>.tar.gz /tmp/restore/
...
# 5. APK
rclone copy gdrive:Backups/ctslab-web/apk/ /var/www/ctslab-downloads/
